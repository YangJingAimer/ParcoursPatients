...
class Patient extends CI_Controller {
    ...
    public function majDisponibilite() {
        ...
        $this->M_DossierParcours->nouvelleDossier($idPatient, $idParcours);
        $data['chemin'] = '/patient/V_rechercher';
        $this->load->view('/V_generale', $data);
    }
    ...
    public function modifierPatient() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $numsecu = $this->input->post("num-secu-patient");
            $naissance = $this->input->post("date-naiss-patient");
            $this->M_Patient->modifierUnPatient($id, $nom, $prenom, $adressenum, $adresseure, $codepostale, $ville, $pays, $mail, $telefix, $tele, $numsecu, $naissance);
